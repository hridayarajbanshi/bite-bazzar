                        ...
                        <div className="relative z-10 flex items-center h-full px-6 md:px-12 lg:px-24">
                            <div className="max-w-2xl text-white">
                                ...
                                <div className="flex items-center gap-4 mb-6">
                                    <span className="text-3xl md:text-4xl font-bold">{slide.price}</span>
                                ...
                                {/* CTA Button */}
                                <button className="group relative overflow-hidden bg-white text-gray-900 px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl">
