...
const App = () => {
    ...
    return (
        <div className="min-h-screen">
            {/* Navigation */}
            <nav className={`fixed top-0 left-0 w-full flex items-center justify-between px-4 md:px-16 lg:px-24 xl:px-32 transition-all duration-500 z-50 ${isScrolled ? "bg-white/80 shadow-md text-gray-700 backdrop-blur-lg py-3 md:py-4" : "bg-indigo-500 py-4 md:py-6 text-white"}`}>
                {/* Logo */}
                ...
                <div className="hidden md:flex items-center gap-4">
                    ...
                    {/* Favorite Button */}
                    <button 
                        className={`p-2 rounded-full transition-all duration-500 ${isScrolled ? "text-gray-700 hover:bg-gray-100" : "text-white hover:bg-white/10"}`}
            ...
            {/* Main Content - Add padding-top to prevent content from being hidden behind navbar */}
            <div className="pt-20">
